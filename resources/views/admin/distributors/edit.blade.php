    ...
    <div class="row">
        <div class="col-lg-9">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" class="needs-validation" action="{{ route('distributors.update', $distributor->id) }}" enctype="multipart/form-data" novalidate>
                        @csrf
                        @method('put')
                        <div class="row mb-3">
                            <div class="col-md-12">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                >{{ $distributor->description }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-check form-switch form-switch-success">
                                        <input 
                                            ...
                                            name="active" 
                                            id="activeSwitch" 
                                            {{ $distributor->is_active == 1 ? 'checked' : '' }}
                                        >
