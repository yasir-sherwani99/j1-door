    ...
    <div class="row">
        <div class="col-lg-9">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" class="needs-validation" action="{{ route('testimonials.update', $testimonial->id) }}" enctype="multipart/form-data" novalidate>
                        @csrf
                        @method('put')
                        <div class="row mb-3">
                            <div class="col-md-12">
...
@section('script')
    ...
    <script>
        ...
        let imagess = JSON.parse(images.replace(/&quot;/g, '"'));
        console.log(imagess)
