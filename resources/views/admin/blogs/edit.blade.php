    ...
    <div class="row">
        <div class="col-lg-9">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" class="needs-validation" action="{{ route('blogs.update', $blog->id) }}" enctype="multipart/form-data" novalidate>
                        @csrf
                        @method('put')
                        <div class="row mb-3">
                            <div class="col-md-12">
...
@section('script')
    ...
    <script>
        ...
        let selectedTaggs = JSON.parse(selectedTags.replace(/&quot;/g, '"'));
        ...
        selector.setValue(selectedTaggs)
    </script>
    ...
    <script>
        ...
        let blogImages = "{{ $blogImages }}";
        let blogImagess = JSON.parse(blogImages.replace(/&quot;/g, '"'));

        $(function () {
            $('.input-images-1').imageUploader({
                preloaded: blogImagess,
